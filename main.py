...
for model_name, model in models.items():
    ...
    writer.add_text("hyperparameters/emb_trainable", str(EMB_TRAINABLE))
    if model.__class__.__name__ == "LSTM":
    ...
    plt.tight_layout()
    plt.savefig(f'{output_dir}/confusion_matrix_{is_multilayered}{is_bidirectional}{model.__class__.__name__}.png')
    print(f"Confusion matrix saved to {output_dir}/confusion_matrix_{is_multilayered}{is_bidirectional}{model.__class__.__name__}.png")
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig(f'{output_dir}/learning_curves_{is_multilayered}{is_bidirectional}{model.__class__.__name__}.png')
    print(f"Learning curves saved to {output_dir}/learning_curves_{is_multilayered}{is_bidirectional}{model.__class__.__name__}.png")
